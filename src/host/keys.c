...
int fl1_scan_codes[]={
	GLFW_KEY_ESC,'1','2','3','4','5','6','7','8','9','0','-','=',GLFW_KEY_BACKSPACE,
	GLFW_KEY_TAB,'Q','W','E','R','T','Y','U','I','O','P','[',']',GLFW_KEY_ENTER,
	GLFW_KEY_LCTRL,'A','S','D','F','G','H','J','K','L',';',0x27,0x60,
	GLFW_KEY_LSHIFT,'\\','Z','X','C','V','B','N','M',',','.','/',GLFW_KEY_RSHIFT,GLFW_KEY_KP_MULTIPLY,			//NOTE KP MULTIPLY FILLS IN FOR MISSING KEY AFTER RSHIFT
	GLFW_KEY_LALT,' ',GLFW_KEY_CAPS_LOCK,
	GLFW_KEY_F1,GLFW_KEY_F2,GLFW_KEY_F3,GLFW_KEY_F4,GLFW_KEY_F5,GLFW_KEY_F6,GLFW_KEY_F7,GLFW_KEY_F8,GLFW_KEY_F9,GLFW_KEY_F10,
	GLFW_KEY_KP_NUM_LOCK,GLFW_KEY_KP_ENTER,
